...
import { DB_HOST, DB_NAME, DB_PASS, DB_PORT, DB_TYPE, DB_USER, IS_DEVELOPMENT } from './Configuration';
...
export default {
    ...
    entities: [
        path.join(__dirname, '../infra/databases/typeorm/entities/*{.js,.ts}')
    ],
    migrations: [
        path.join(__dirname, '../infra/databases/typeorm/migration/*{.js,.ts}')
    ],
    // entities: [
